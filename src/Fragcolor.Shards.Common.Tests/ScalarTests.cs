...
{
  /// <summary>
  /// Tests for scalar types in shards.
  /// </summary>
  [TestFixture]
...
#pragma warning restore CS8618
    ...
    public ref SHVar InVar => ref _inputVar.Value;

    public ref SHVar OutVar => ref _outputVar.Value;

    /// <summary>
    /// Initializes a wire and two external variables resp. for input and output.
    /// </summary>
    [SetUp]
    public void Setup()
    {
      ...
      _wire = new Variable();
      var ok = Env.Eval(@$"(Wire ""{name}"" :Looped .input (Log) > .output)", _wire.Ptr);
      Assert.IsTrue(ok);
      Assert.IsTrue(Wire.IsValid());

      _inputVar = new ExternalVariable(Wire, "input");
      _outputVar = new ExternalVariable(Wire, "output");
    }

    /// <summary>
    /// Cleans up the wire and the external variables.
    /// </summary>
    [TearDown]
    ...
    /// <summary>
    /// Tests <see cref="SHType.Bool"/> variables.
    /// </summary>
    [Test]
    public void TestBool()
    {
      ...
      Assert.AreEqual(SHType.Bool, InVar.type);
      Assert.AreEqual(@bool, (bool)InVar.@bool);

      OutVar.SetValue(default(bool));
      Assert.AreEqual(SHType.Bool, OutVar.type);
    ...
    /// <summary>
    /// Tests <see cref="SHType.Int"/> variables.
    /// </summary>
    [Test]
    public void TestInt()
    {
      ...
      Assert.AreEqual(SHType.Int, InVar.type);
      Assert.AreEqual(@int, InVar.@int);

      OutVar.SetValue(default(int));
      Assert.AreEqual(SHType.Int, OutVar.type);
    ...
    /// <summary>
    /// Tests <see cref="SHType.Int2"/> variables.
    /// </summary>
    [Test]
    public void TestInt2()
    {
      ...
      Assert.IsFalse(InVar.IsFloat());
      Assert.IsTrue(InVar.IsInteger());
      Assert.AreEqual(SHType.Int2, InVar.type);
      Assert.AreEqual(int2, InVar.int2);

      OutVar.SetValue(default(Int2));
      Assert.AreEqual(SHType.Int2, OutVar.type);
    ...
    /// <summary>
    /// Tests <see cref="SHType.Int3"/> variables.
    /// </summary>
    [Test]
    public void TestInt3()
    {
      ...
      Assert.IsFalse(InVar.IsFloat());
      Assert.IsTrue(InVar.IsInteger());
      Assert.AreEqual(SHType.Int3, InVar.type);
      Assert.AreEqual(int3, InVar.int3);

      OutVar.SetValue(default(Int3));
      Assert.AreEqual(SHType.Int3, OutVar.type);
    ...
    /// <summary>
    /// Tests <see cref="SHType.Int4"/> variables.
    /// </summary>
    [Test]
    public void TestInt4()
    {
      ...
      Assert.IsFalse(InVar.IsFloat());
      Assert.IsTrue(InVar.IsInteger());
      Assert.AreEqual(SHType.Int4, InVar.type);
      Assert.AreEqual(int4, InVar.int4);

      OutVar.SetValue(default(Int4));
      Assert.AreEqual(SHType.Int4, OutVar.type);
    ...
    /// <summary>
    /// Tests <see cref="SHType.Int8"/> variables.
    /// </summary>
    [Test]
    public void TestInt8()
    {
      ...
      Assert.IsFalse(InVar.IsFloat());
      Assert.IsTrue(InVar.IsInteger());
      Assert.AreEqual(SHType.Int8, InVar.type);
      Assert.AreEqual(int8, InVar.int8);

      OutVar.SetValue(default(Int8));
      Assert.AreEqual(SHType.Int8, OutVar.type);
    ...
    /// <summary>
    /// Tests <see cref="SHType.Int16"/> variables.
    /// </summary>
    [Test]
    public void TestInt16()
    {
      ...
      Assert.IsFalse(InVar.IsFloat());
      Assert.IsTrue(InVar.IsInteger());
      Assert.AreEqual(SHType.Int16, InVar.type);
      Assert.AreEqual(int16, InVar.int16);

      OutVar.SetValue(default(Int16));
      Assert.AreEqual(SHType.Int16, OutVar.type);
    ...
    /// <summary>
    /// Tests <see cref="SHType.Float"/> variables.
    /// </summary>
    [Test]
    public void TestFloat()
    {
      ...
      Assert.IsFalse(InVar.IsInteger());
      Assert.AreEqual(SHType.Float, InVar.type);
      Assert.AreEqual(@float, InVar.@float);

      OutVar.SetValue(default(double));
      Assert.AreEqual(SHType.Float, OutVar.type);
    ...
    /// <summary>
    /// Tests <see cref="SHType.Float2"/> variables.
    /// </summary>
    [Test]
    public void TestFloat2()
    {
      ...
      Assert.IsTrue(InVar.IsFloat());
      Assert.IsFalse(InVar.IsInteger());
      Assert.AreEqual(SHType.Float2, InVar.type);
      Assert.AreEqual(float2, InVar.float2);

      OutVar.SetValue(default(Float2));
      Assert.AreEqual(SHType.Float2, OutVar.type);
    ...
    /// <summary>
    /// Tests <see cref="SHType.Float3"/> variables.
    /// </summary>
    [Test]
    public void TestFloat3()
    {
      ...
      Assert.IsTrue(InVar.IsFloat());
      Assert.IsFalse(InVar.IsInteger());
      Assert.AreEqual(SHType.Float3, InVar.type);
      Assert.AreEqual(float3, InVar.float3);

      OutVar.SetValue(default(Float3));
      Assert.AreEqual(SHType.Float3, OutVar.type);
    ...
    /// <summary>
    /// Tests <see cref="SHType.Float4"/> variables.
    /// </summary>
    [Test]
    public void TestFloat4()
    {
      ...
      Assert.IsTrue(InVar.IsFloat());
      Assert.IsFalse(InVar.IsInteger());
      Assert.AreEqual(SHType.Float4, InVar.type);
      Assert.AreEqual(float4, InVar.float4);

      OutVar.SetValue(default(Float4));
      Assert.AreEqual(SHType.Float4, OutVar.type);
    ...
    /// <summary>
    /// Tests <see cref="SHType.Color"/> variables.
    /// </summary>
    [Test]
    public void TestColor()
    {
      var color = new SHColor() { r = 33, g = 34, b = 35, a = 255 };
      var (r, g, b, a) = color;
      ...
      Assert.IsFalse(InVar.IsFloat());
      Assert.IsTrue(InVar.IsInteger());
      Assert.AreEqual(SHType.Color, InVar.type);
      Assert.AreEqual(color, InVar.color);

      OutVar.SetValue(default(SHColor));
      Assert.AreEqual(SHType.Color, OutVar.type);
