...
{
  internal static class ShardsEditorUtility
  {
    public const string EditorResourcesFolder = "Editor Resources";
    public const string PackageName = "com.fragcolor.shards";
    public const string PackageDisplayName = "Shards";
    ...
    private static string? GetPackagePath(bool isAbsolute)
    {
      ...
      // Search for default location of normal Shards AssetStore package
